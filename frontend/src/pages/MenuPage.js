...
function MenuPage() {
  ...
  return (
    <main>
      <div style={{ background: "#f9e0ae", padding: "2rem 0", textAlign: "center" }}>
        <h1 style={{ fontFamily: "'Fredoka One', cursive", color: "#c24914" }}>Our Donuts</h1>
      ...
      <DonutGrid category={selectedCategory === "All" ? null : selectedCategory} />
    </main>
  );
}
